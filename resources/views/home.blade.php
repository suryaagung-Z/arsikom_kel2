            ...
            <div class="col-md-10 col-lg-7 mr-auto index-carousel">
                <div class="owl-carousel owl-theme default-carousel nav-0 z-index mt-md-4 mt-xl-5 pt-md-4 pt-xl-5 dots-0 pb-md-5">
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <h1 class="fables-main-text-color font-weight mb-1">Terbaru di Laptop GAMING</h1>
                        <p class="fables-forth-text-colo mb-3 light-font fables-header-slider-details">
                            Telusuri perkembangan dan tren terbaru dalam laptop gaming, menawarkan kinerja dan pengalaman yang luar biasa.
                        </p>
                    </div>
                    <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".8s">
                        <h1 class="fables-main-text-color font-weight mb-1">Terbaru di Laptop GAMING</h1>
                        <p class="fables-forth-text-colo mb-3 light-font fables-header-slider-details">
                            Temukan teknologi dan inovasi terbaru yang mendorong evolusi laptop gaming, memberikan kinerja dan mobilitas yang belum pernah terjadi sebelumnya.
                        </p>
                    </div>
                </div>
    ...
    <div class="row overflow-hidden">
       <div class="col-12">
        ...
        <div class="col-12 col-md-4 mb-4 mb-lg-5 wow bounceInLeft" data-wow-delay=".4s" data-wow-duration="1.5s"> 
               ...
               <h2 class="font-18 semi-font font-18  mt-3"><a href="/blogdetail" class="fables-main-text-color fables-second-hover-color">Getting to Another Level of Design</a></h2>
               ...
               <a href="/blogdetail" class="btn fables-main-text-color fables-second-hover-color p-0 underline mt-2">Read More</a> 
             ...
             <div class="row">
                ...
                <div class="col-12 col-lg-6 bg-white px-6 py-3 py-md-5 wow fadeInRight" data-wow-delay="1s" data-wow-duration="1.5s">
                    ...
                    <p class="fables-main-text-color font-14 my-3">
                        ASUS ROG Strix Scar 16 (G634) tidak hanya memenuhi kebutuhan gaming yang tinggi, tetapi juga memberikan pengalaman gaming yang luar biasa dan tanpa kompromi bagi para pengguna.                    </p>
                    <div id="accordion">
                          <div class="card border-0 mb-2">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                              <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Didukung oleh prosesor 13th Gen Intel Core i9-13980HX yang sangat bertenaga, laptop ini menawarkan performa maksimal untuk menjalankan game AAA terbaru dan tugas-tugas berat lainnya tanpa kendala.                              </div>
                            </div>
                          </div>
                          <div class="card border-0 mb-2">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                              <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Dilengkapi dengan kartu grafis terbaik hingga NVIDIA GeForce RTX 4090 Laptop GPU, laptop ini menyajikan pengalaman visual yang luar biasa dengan detail yang tajam dan grafis yang mulus.                              </div>
                            </div>
                          </div>
                          <div class="card border-0 mb-2">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                              <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Layar Mini LED berteknologi ROG Nebula HDR Display berukuran 16 inci dengan resolusi Quad HD+ 2560x1600 pixel memberikan pengalaman gaming yang memukau dengan refresh rate 240Hz dan 3ms response time.                              </div>
                            </div>
                          </div>
                          <div class="card border-0 mb-2">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                              <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Pengguna yang membeli laptop ini akan mendapatkan akses gratis Xbox Game Pass selama 3 bulan, memberikan akses ke berbagai pilihan game AAA terbaru yang dapat dimainkan tanpa harus membeli secara terpisah.                              </div>
                            </div>
                          </div>
                        </div>
                </div>
