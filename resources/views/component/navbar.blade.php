                        ...
                        <ul class="navbar-nav mx-auto fables-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link {{ Request::routeIs('home') ? 'text-danger' : '' }}"
                                    href="{{ route('home') }}" id="sub-nav1" style="{{ Request::routeIs('home') ? '' : 'color: black;' }}">
                                    Home
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link {{ Request::routeIs('about') ? 'text-danger' : '' }}"
                                    href="{{ route('about') }}" id="sub-nav3" style="{{ Request::routeIs('home') ? '' : 'color: black;' }}">
                                    About
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link {{ Request::routeIs('blog') ? 'text-danger' : '' }}"
                                    href="{{ route('blog') }}" id="sub-nav5" style="{{ Request::routeIs('home') ? '' : 'color: black;' }}">
                                    Laptop
                                </a>
                            </li>
